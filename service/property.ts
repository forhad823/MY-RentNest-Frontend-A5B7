...
export async function getProperties(
  ...
  try {
    ...
    if (filters.bedroomCount !== undefined) params.set("bedroomCount", filters.bedroomCount.toString());
    if (filters.bathroomCount !== undefined) params.set("bathroomCount", filters.bathroomCount.toString());
 ...
 ****/
export async function getPropertyById(id: string): Promise<TApiResponse<TProperty | null>> {
  try {
